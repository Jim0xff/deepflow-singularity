...
function buildStep7WriterMessage(ctx) {
  ...
  return [
    ...
    `Project root: ${ctx.projectDir}`,
    "Current step: step_7_drafting",
    "Read project.md, status.md, handoff.md, interaction_log.md, materials.md, output.md, draft_review_history.md, and source_pack_queries.json if present.",
    ...
    "If the latest editor feedback or latest reviewer review explicitly requests source-pack material, read the latest matching entries from source_pack_queries.json first. Do not read raw source-pack files unless the block explicitly requires raw source-pack reading.",
    ...
    "Before writing draft_review_history.md, read its existing contents first. Keep the entire existing file unchanged as prefix and append exactly one new final block at the end. Never rewrite, truncate, replace, or shorten the existing file.",
...
function buildStep7ReviewerMessage(ctx) {
  ...
  return [
    ...
    "Read project.md, status.md, handoff.md, output.md, final-output.md, draft_review_history.md, and source_pack_queries.json if present.",
    ...
    "Do not read templates from the project directory.",
    `Ignore all prior session context. Use only project.md, status.md, handoff.md, output.md, final-output.md, draft_review_history.md, and source_pack_queries.json from ${ctx.projectDir}. This dispatch is editorial review only, not Step 5 debate, not active-project menu routing, and not generic chat. Do not output 1/2/3 menus, status-only notes, or debate continuation text.`,
    ...
    "If the latest editor feedback block explicitly requests source-pack material, read the latest matching entries from source_pack_queries.json first. Do not read raw source-pack files unless the block explicitly requires raw source-pack reading.",
...
function buildFinalWriterMessage(ctx) {
  ...
  return [
    ...
    `Project root: ${ctx.projectDir}`,
    "Current step: step_8_final_article",
    `Read project.md, status.md, handoff.md, ${revise ? "final-output.md" : "output.md"}, and source_pack_queries.json if present.`,
    revise
    ...
    "If the latest final-stage editor or reviewer block explicitly requests source-pack material, read the latest matching entries from source_pack_queries.json first. Do not read raw source-pack files unless the block explicitly requires raw source-pack reading.",
    "Do not append any menu, bot handoff options, or @bot instructions.",
    "",

...
const STEP_7_WRITER_MESSAGE = [
  ...
  "Read all relevant shared writing rules under /.openclaw/shared/knowledge/writing_rules/.",
...
const STEP_7_REVIEWER_MESSAGE = [
  ...
  "Read all relevant shared review gates under /.openclaw/shared/knowledge/review_gates/.",
  "Read all relevant shared repair patterns under /.openclaw/shared/knowledge/repair_patterns/.",
